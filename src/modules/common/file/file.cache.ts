...
// import { FilePaginationDto } from './schemas';

export const FileCacheKeys = {
  byId: (id: MongoId) => buildKey('file', toStringId(id)),

  list: (queryKey: string, version: number) => buildKey('files', `v${version}`, queryKey),
};

export const TEMPLATE_CACHE_VERSION_KEYS = {
  LIST: 'files:list:version',
};

export class FileCacheVersion {
...
// export const buildQueryKey = (query: FilePaginationDto) => {
//   const parts = [];
